...
mod test {
    ...
    fn test_mint_energy() {
        ...
        // El contrato de distribución mintea 100 kWh
        client.mint_energy(&user, &100_0000000, &distribution); // 100 kWh con 7 decimales
    ...
    fn test_burn_energy() {
        ...
        // Usuario quema 30 kWh (consumió energía)
    ...
    fn test_transfer_between_users() {
        ...
        // User1 vende 20 kWh a User2 (trading P2P)
    ...
    fn test_grant_and_revoke_minter() {
        ...
        // Admin otorga rol de minter a nueva dirección
        client.grant_minter(&new_minter);
        assert!(client.is_minter(&new_minter));

        // Admin revoca rol de minter
    ...
    fn test_initial_supply() {
        ...
        // Inicializar con supply de 1000 kWh
